...
''')
  print ('\033[94m-'*50)
  print ('')
  print (' \033[96m Author   : \033[95m Black Devil MHK')
  print ('')
  print (' \033[96m Tool     : \033[95m Facebook Downloader')
  print ('')
  print (' \033[96m Facebook : \033[95m https://www.facebook.com/Its.BlackDevilMHK69/')
  print ('')
  print (' \033[96m Github   : \033[95m https://www.github.com/BlackDevilMHK/')
  print ('')
  print (' \033[96m Coded By : \033[95m B2A6K D3V1L-MHK')
  print ('')
  print ('\033[94m-'*50)
  print ('')
